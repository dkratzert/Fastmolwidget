...
class MoleculeViewer3DWidget(DensityControlsMixin, QtWidgets.QWidget):
    ...
    * **Parts** *Shown only when disorder parts are present)* –
    ...
    def show_residual_density(self, hkl_path: str | Path | None = None,
        ...
        See :meth:`fastmolwidget.density_controls.DensityControlsMixin.show_residual_density`.
        """
...
if __name__ == "__main__":
    ...
    w.load_file(r"D:\OneDrive\OneDrive - Bruker Physik GmbH\Dokumente\ACA_summer_course\02_disorder\BB_LJ45_a.res")
